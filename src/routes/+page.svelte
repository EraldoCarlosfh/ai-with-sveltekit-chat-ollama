		...
		<div class="p-4 space-y-4">
			...
			<div class="space-y-2">
				<div class="rounded-lg border bg-card text-card-foreground shadow-sm p-2" data-v0-t="card">
					<div class="p-6">
						<h3 class="font-semibold">Carlos Oliveira</h3>
						<p class="text-xs text-zinc-500">Última mensagem...</p>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="flex flex-col w-full">
		<header class="border-b p-4">
			<h2 class="text-xl font-bold flex items-center gap-2">
				...
				<div>
					Carlos Oliveira<span class="text-xs text-green-600 block">Online</span>
				</div>
			</h2>
		</header>
